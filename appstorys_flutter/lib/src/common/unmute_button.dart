...
class UnmuteButton extends StatelessWidget {
  ...
  Widget _buildIcon(double size, Color color) {
    // Always use unmute.png from local assets
    const String path = 'lib/assets/icons/unmute.png';
    ...
    return Image.asset(
      ...
      errorBuilder: (context, error, stackTrace) {
        debugPrint('Error loading unmute.png: $error');
        return SizedBox(
          width: size,
          height: size,
          child: Icon(
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final double size = iconSize ??
            _getDoubleValue(
              styling?['size'],
              _getDoubleValue(styling?['unmuteButtonSize'], defaultSize),
            );
          ...
          child: Padding(
            ...
            child: SizedBox(
              ...
              child: DecoratedBox(
                ...
                child: Center(
                  // unmute.png with color applied from backend
