...
class ShareButton extends StatelessWidget {
  ...
  Widget _buildIcon(double size, Color color) {
    // Always use share.png from local assets
    const String path = 'lib/assets/icons/share.png';
    ...
    return Image.asset(
      ...
      errorBuilder: (context, error, stackTrace) {
        debugPrint('Error loading share.png: $error');
        return SizedBox(
          width: size,
          height: size,
          child: Icon(
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final double size = iconSize ??
            _getDoubleValue(
              styling?['size'],
              _getDoubleValue(styling?['shareButtonSize'], defaultSize),
            );
          ...
          child: Padding(
            ...
            child: SizedBox(
              ...
              child: DecoratedBox(
                ...
                child: Center(
                  // share.png with color applied from backend
