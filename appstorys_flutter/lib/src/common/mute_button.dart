...
class MuteButton extends StatelessWidget {
  ...
  Widget _buildIcon(double size, Color color) {
    // Always use mute.png from local assets
    const String path = 'lib/assets/icons/mute.png';
    ...
    return Image.asset(
      ...
      errorBuilder: (context, error, stackTrace) {
        debugPrint('Error loading mute.png: $error');
        return SizedBox(
          width: size,
          height: size,
          child: Icon(
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final double size = iconSize ??
            _getDoubleValue(
              styling?['size'],
              _getDoubleValue(styling?['muteButtonSize'], defaultSize),
            );
          ...
          child: Padding(
            ...
            child: SizedBox(
              ...
              child: DecoratedBox(
                ...
                child: Center(
                  // mute.png with color applied from backend
