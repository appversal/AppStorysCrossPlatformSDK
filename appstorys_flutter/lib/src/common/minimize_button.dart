...
class MinimiseButton extends StatelessWidget {
  ...
  Widget _buildIcon(double size, Color color) {
    // Always use minimize.png from local assets
    const String path = 'lib/assets/icons/minimize.png';
    ...
    return Image.asset(
      ...
      errorBuilder: (context, error, stackTrace) {
        debugPrint('Error loading minimize.png: $error');
        return SizedBox(
          width: size,
          height: size,
          child: Icon(
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final double size = iconSize ??
            _getDoubleValue(
              styling?['size'],
              _getDoubleValue(styling?['minimiseButtonSize'], defaultSize),
            );
          ...
          child: Padding(
            ...
            child: SizedBox(
              ...
              child: DecoratedBox(
                ...
                child: Center(
                  // minimize.png with color applied from backend
