...
// Extends PlatformInterface — Flutter's standard pattern for plugins
// that need to support multiple platforms (Android, iOS, web)
abstract class AppstorysFlutterPlatform extends PlatformInterface {
  ...
  // Default implementation points to MethodChannel (Android/iOS)
  // Can be swapped for web or test implementations
